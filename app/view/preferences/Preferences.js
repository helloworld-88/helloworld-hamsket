		...
		this.items = [
			{
				...
				items: [
					...
					},
					{
						...
						store: Ext.create('Ext.data.Store', {
							...
							data: [
								...
								{
									value: 'taskbar_tray',
									label: 'Show in Taskbar and Tray Icon',
								},
							],
						}),
						hidden: process.platform === 'darwin',
						...
						store: Ext.create('Ext.data.Store', {
							...
							data: [
								{ value: 'keep_in_tray', label: 'Keep in tray' },
								{
									...
									label: 'Keep in tray and/or taskbar',
								},
					...
					},
					{
						xtype: 'fieldset',
						title:
							'Proxy (needs to relaunch) - <a href="https://github.com/helloworld-88/helloworld-hamsket/wiki/FREE-PROXY-SERVERS" target="_blank">Free Proxy Servers</a>',
